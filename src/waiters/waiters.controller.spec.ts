...
describe('WaitersController', () => {
  let waitersController: WaitersController;
  ...
  beforeEach(async () => {
    ...
    waitersController = module.get<WaitersController>(WaitersController);
    waitersService = module.get<WaitersService>(WaitersService);
  });

  it('should be defined', () => {
    expect(waitersController).toBeDefined();
  });
  ...
  it('should create a new waiter', async () => {
    ...
    const result = await waitersController.create(newWaiter);
  ...
  it('should find all waiters', async () => {
    ...
    const result = await waitersController.findAll();
  ...
  it('should find a waiter by ID', async () => {
    ...
    const result = await waitersController.findOne(waiterId);
  ...
  it('should update a waiter', async () => {
    ...
    const result = await waitersController.update(
      { id: waiterId },
      updatedWaiter
    );
